...
/**
 * The synthetic data process needs to be provided with a set of names to use when generating
 * fake data. One approach is to use a class path resource file. {@link ClassPathResourceBasedNames}
 */
